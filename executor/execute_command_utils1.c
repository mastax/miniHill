...
static void	execute_child_process_part2(t_command_context1 *ctx, t_arg *current_cmd)
{
	char	*cmd_path;
...
static void	execute_child_process_part1(t_command_context1 *ctx, t_arg *current_cmd)
{
	int	builtin_result;
